...
def roll_dice(num_rolls, dice=six_sided):
    ...
    return (pigout_case and 1) or total
...
def take_turn(num_rolls, opponent_score, dice=six_sided):
    ...
    # BEGIN PROBLEM 3
    if num_rolls == 0:
        return 2 + abs(opponent_score // 10 - opponent_score % 10) #return free_bacon(opponent_score)
    else:
        sumPoints = roll_dice(num_rolls, dice)
...
def is_swap(score0, score1):
    ...
    if score0 == 0 or score1 == 0:
        return False
    elif (score0 % score1 == 0 or score1 % score0 == 0) and score0 != 1 and score1 != 1:
        return True
    else:
        return False
    # END PROBLEM 4
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def say(score0, score1):
        if who == 0:
            ...
            elif difference > previous_high and difference != 0:
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    for n in range(1, 11):
        #averaged_dice = make_averaged(roll_dice, num_samples) fixed this by putting it outside for loop
        average_score = averaged_dice(n, dice)
