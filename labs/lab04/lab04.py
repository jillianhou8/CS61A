...
def if_this_not_that(i_list, this):
    ...
    5
    """
    #[print(x) for x in i_list if x > this] doesn't print the that though...hmm
...
def distance(city1, city2):
    ...
    5.0
    """
    c1_x, c1_y = get_lat(city1), get_lon(city1)
    c2_x, c2_y = get_lat(city2), get_lon(city2)

    return sqrt((c1_x - c2_x)**2 + (c1_y - c2_y)**2)
